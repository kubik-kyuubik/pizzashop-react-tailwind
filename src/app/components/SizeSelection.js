...
const SizeSelection = ({ pizza, size, setSize }) => {
  return (
    <div className="mx-auto max-w-sm lg:max-w-none flex item-center justify-center lg:justify-start">
      {/* sizes */}
      <div className="flex gap-x-12 item-baseline mb-10 font-medium">
        {/* small */}
